...
async function main() {
  ...
  const RecycleRecordContract = await hre.ethers.getContractFactory(
    "RecycleRecordContract"
  );
  const recycleRecordContract = await RecycleRecordContract.deploy(
    identityAddress
  );
  ...
  const certificateAddress = await certificateContract.getAddress();
  console.log("✅ CertificateContract deployed to:", certificateAddress);
  console.log();
  ...
  const deploymentInfo = {
    ...
    contracts: {
      ...
      CertificateContract: certificateAddress,
    },
  };
  ...
  console.log("CertificateContract:    ", certificateAddress);
  console.log("═══════════════════════════════════════════════════════");
