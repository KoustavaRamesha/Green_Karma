...
import { Leaf, User, Wallet } from 'lucide-react';
        ...
        <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-md w-full">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="mt-2 text-gray-600">Start earning Carbon Tokens today</p>
                </div>
                ...
                <div className="card">
                    <div className="space-y-6">
                            ...
                            <div className="flex gap-4">
                                <label className="flex-1 cursor-pointer">
                                    <input
                                        ...
                                        className="sr-only"
                                    />
                                    <div className={`p-4 border-2 rounded-lg text-center transition ${formData.role === 'user'
                                            ? 'border-primary-500 bg-primary-50'
                                            : 'border-gray-200 hover:border-gray-300'
                                        }`}>
                                        <div className="font-semibold">User</div>
                                        <div className="text-sm text-gray-600">Recycle & Earn</div>
                                    </div>
                                </label>
                                <label className="flex-1 cursor-pointer">
                                    <input
                                        ...
                                        className="sr-only"
                                    />
                                    <div className={`p-4 border-2 rounded-lg text-center transition ${formData.role === 'verifier'
                                            ? 'border-primary-500 bg-primary-50'
                                            : 'border-gray-200 hover:border-gray-300'
                                        }`}>
                                        <div className="font-semibold">Verifier</div>
                                        <div className="text-sm text-gray-600">Government Official</div>
                                    </div>
                                </label>
                            </div>
                        </div>
                        ...
                        <button
                            ...
                            className="w-full bg-white border-2 border-gray-300 text-gray-700 font-semibold py-3 px-6 rounded-lg hover:bg-gray-50 transition flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                            {loading ? (
                                'Creating Account...'
                            ) : (
